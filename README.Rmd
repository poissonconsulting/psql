...
You must have a default connection as shown in the example `config.yml` file above.
...
To use the credentials supplied for the data_user set `psql.config_value` to `"data_user"` from the default option `"default"`. 
